...
function renderHeader() {
  ...
  const servicePages = ["journal-publishing-support.html", "digital-library-support.html", "conference-support.html", "society-partnerships.html"];
  const active = servicePages.includes(current) ? "research-services.html" : current;
...
function renderFooter() {
  ...
  target.innerHTML = `<div class="footer-grid">
    <div class="footer-about"><a href="index.html" class="footer-brand"><img src="i-proclaim-logo.png" alt="i-Proclaim.com"></a><p>An independent platform supporting scholarly publication, research development, academic collaboration and responsible knowledge dissemination.</p><address class="contact-block" id="contact"><strong>Contact</strong><a href="tel:+601156517351">+60 11-5651 7351</a><span>Kuala Lumpur, Malaysia</span><span>21-09-06, Taman Bukit Angkasa,<br>Off Pantai Dalam, 59200 Kuala Lumpur, Malaysia</span><strong>Support Email</strong><a href="mailto:support@i-proclaim.my">support@i-proclaim.my</a></address></div>
    ...
    <div><h2>Research Services</h2><a href="journal-publishing-support.html">Journal Publishing Support</a><a href="digital-library-support.html">Digital Library Support</a><a href="conference-support.html">Conference Support</a><a href="society-partnerships.html">Society Partnerships</a></div>
